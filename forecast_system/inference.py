...
from .post_processing import post_process_predictions, format_forecast_output
from .conformal_calibration import enforce_quantile_monotonicity
...
def forecast(model,
    ...
    if hospital_ids is not None:
        ...
        X_inference = X_inference[inference_df.index].copy()
